...
public class Regulation {
	...
	private static Vector3 Va = new Vector3(-Math.cos(30) * RADIUSA, 0, -Math.sin(30) * RADIUSA);
	private static Vector3 Vb = new Vector3(0, 0, RADIUSA);
	private static Vector3 Vc = new Vector3(Math.cos(30) * RADIUSA, 0, -Math.sin(30) * RADIUSA);
	private static Vector3 Vd = new Vector3(0, -HEIGHT, -RADIUSA);
	private static Vector3 Ve = new Vector3(-Math.cos(30) * RADIUSA, -HEIGHT, Math.sin(30) * RADIUSA);
	private static Vector3 Vf = new Vector3(Math.cos(30) * RADIUSA, -HEIGHT, Math.sin(30) * RADIUSA);
	...
	public static FSBPosition calculatePosition(double x, double y, double z, double rotX, double rotY, double rotZ) {
		Matrix3 RotMatrix = Matrix3.getRotationMatrix(rotX, rotY, rotZ);
