...
public class MathsTest {
	...
	public void testRotationMatrix() {
		Vector3 rotationVector = new Vector3(1.0, 0.0, 0.0);
		Matrix3 rotationMatrix = Matrix3.getRotationMatrix(0, Math.toRadians(45), 0);
		
		Vector3 result = rotationMatrix.multiply(rotationVector);
		result.printToScreen();
		Assert.assertTrue(result.x == 0.7071067690849304);
		Assert.assertTrue(result.y == 0.0);
		Assert.assertTrue(result.z == 0.7071067690849304);
	}
}
